...
Example downloaded from [here](https://github.com/NVIDIA/NVFlare/tree/main/examples/hello-world/hello-numpy). This section contains my personal notes. The rest of the README is a copied from the original GitHub repo.
