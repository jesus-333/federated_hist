...
TODO
- V2. Config readed from an external file and synthetic data.
- V3. Config readed from an external file and data readed from an external file


# How to ...

## How to run app as flower simulation?
